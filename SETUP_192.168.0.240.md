...
All services are accessible at your Raspberry Pi: **192.168.0.240**

| Service | URL | Port |
|---------|-----|------|
| **Jellyfin** (Media Server) | `http://192.168.0.240/` | 8096 |
| **Radarr** (Movies) | `http://192.168.0.240/radarr` | 7878 |
| **Sonarr** (TV Shows) | `http://192.168.0.240/sonarr` | 8989 |
| **Lidarr** (Music) | `http://192.168.0.240/lidarr` | 8686 |
| **Readarr** (Books) | `http://192.168.0.240/readarr` | 8787 |
| **Bazarr** (Subtitles) | `http://192.168.0.240/bazarr` | 6767 |
| **Prowlarr** (Indexers) | `http://192.168.0.240/prowlarr` | 9696 |
| **Jackett** (Indexer Proxy) | `http://192.168.0.240/jackett` | 9117 |
| **Transmission** (Torrents) | `http://192.168.0.240/transmission` | 9091 |
| **Kavita** (Comics/eBooks) | `http://192.168.0.240/kavita` | 5000 |
| **Argo CD** (GitOps) | `http://192.168.0.240/argocd/` | 443 |
...
1. Visit: `http://192.168.0.240/transmission`
...
1. Visit: `http://192.168.0.240/prowlarr`
2. **Settings → General:**
...
1. Visit: `http://192.168.0.240/radarr`
2. **Settings → General:**
...
1. Visit: `http://192.168.0.240/sonarr`
2. **Settings → General:**
   - API Key: Copy this
3. **Settings → Download Clients:**
...
1. Visit: `http://192.168.0.240/lidarr`
...
1. Visit: `http://192.168.0.240/readarr`
...
1. Visit: `http://192.168.0.240/bazarr`
2. **Settings → Indexers:**
...
1. Visit: `http://192.168.0.240/kavita`
2. Create account
